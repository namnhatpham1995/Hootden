...
1. Optional: create a Google OAuth client with redirect URI `https://<railway-origin>/auth/google/callback`, to offer Google sign-in alongside email/password. Skip this and email/password is the only sign-in method.
